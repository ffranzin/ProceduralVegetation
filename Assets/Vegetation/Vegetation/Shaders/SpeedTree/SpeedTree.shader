...
Shader "Vegetation/SpeedTreeDrawInstanced"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #pragma instancing_options procedural:setup assumeuniformscaling maxcount:5000
    ...
    SubShader
    {
        ...
        CGPROGRAM
            #pragma surface SpeedTreeSurf Standard vertex:SpeedTreeVert addshadow
