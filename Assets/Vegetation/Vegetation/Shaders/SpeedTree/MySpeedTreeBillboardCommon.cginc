...
#ifndef MY_SPEEDTREE_BILLBOARD_COMMON_INCLUDED
#define MY_SPEEDTREE_BILLBOARD_COMMON_INCLUDED
...
void SpeedTreeBillboardVert(inout SpeedTreeBillboardData IN, out Input OUT)
{
    ...
    float3 worldPos = IN.vertex.xyz + unity_ObjectToWorld._14_24_34;
