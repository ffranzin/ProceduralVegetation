...
#ifndef MY_SPEEDTREE_COMMON_INCLUDED
#define MY_SPEEDTREE_COMMON_INCLUDED
...
void SpeedTreeVert(inout SpeedTreeVB IN, out Input OUT)
{
    ...
    OUT.color = float4(_InstanceLODLevel == 0, _InstanceLODLevel == 1, _InstanceLODLevel == 2, 1);
