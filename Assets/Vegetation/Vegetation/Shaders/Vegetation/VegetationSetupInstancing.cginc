#ifndef STATIC_ELEMENTS_SETUP_INSTANCING
#define STATIC_ELEMENTS_SETUP_INSTANCING
...
#include "Assets/Vegetation/Vegetation/Shaders/GroundVegetation/GroundVegetationWindWave.cginc"
	...
	void setup()
	{
			...
			transform.scale = transform.scale * _Scale;
			...
			unity_ObjectToWorld = mul(unity_ObjectToWorld, GetRotationMatrixYAxis(radians(transform.position.x * transform.position.z)));

			unity_WorldToObject = unity_ObjectToWorld;
			unity_WorldToObject._14_24_34 *= -1;
			unity_WorldToObject._11_22_33 = 1.0f / unity_WorldToObject._11_22_33;
			
			UpdateWind(transform.position.xz, 1);
		#endif
	}
